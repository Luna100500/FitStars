...
var preview = document.querySelectorAll(".coaches__preview");
...
var prevBtn = document.querySelector(".trainers__swiper-button-prev");
var nextBtn = document.querySelector(".trainers__swiper-button-next");
var currentSwiper = new Swiper(".swiper", {
  spaceBetween: 0,
  slidesPerView: 1,
  rewind: true,
...
function play() {
  document.getElementById("vidwrap").innerHTML = '<iframe width="364" height="228" src="https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1" frameborder="0"></iframe>';
}
