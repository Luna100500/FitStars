...
/* harmony import */ var _modules_coaches__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/coaches */ "./js/modules/coaches.js");
...
/* harmony import */ var _modules_feedback__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/feedback */ "./js/modules/feedback.js");
...
var preview = document.querySelector(".coaches__preview");
...
var subscriptionPeriodButtonContainer = document.getElementsByClassName("subscription__period-list");
...
var activateButton = function activateButton(index) {
  Array.from(subscriptionPeriodButtons).find(function (button, buttonIndex) {
...
var showTab = function showTab(index) {
  Array.from(subscriptionRateLists).find(function (rateList, rateListIndex) {
...
var initSubscriptions = handleButtonClick(0);
